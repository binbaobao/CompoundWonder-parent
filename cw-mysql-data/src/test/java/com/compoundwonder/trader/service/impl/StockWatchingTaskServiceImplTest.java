...
class StockWatchingTaskServiceImplTest {
    ...
    @Test
    void calculatesFiveDayAmplitudeFromLowestAdjustedPriceIncludingCurrentDay() {
        ...
        double amplitude = StockWatchingTaskServiceImpl
                .calculateFiveDayAdjustedAmplitude(dailyList);

        assertEquals(35.0, amplitude, 0.000001);
    }

    @Test
    void returnsZeroWhenFiveTradingDaysIncludingCurrentDayAreUnavailable() {
        List<StockDailyEntity> dailyList = List.of(
                daily("2026-07-14", 9.4, 10.4),
