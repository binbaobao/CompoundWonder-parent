 ...
 */
final class FirstBoardChipFilter {
     ...
     */
    static Decision evaluate(FirstBoardSelectionAssist assist) {
     ...
     * 执行普通首板独立遵守的历史筹码硬规则。
     */
    static Decision evaluateHistoricalHardLimits(FirstBoardSelectionAssist assist) {
        if (assist == null
